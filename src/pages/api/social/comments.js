            ...
            try {
                ...
                if (token, content) {
                    ...
                    if (verify) {
                        ...
                        if (replyComId) {
                            let comment = await PalataComments.findOne({
                        ...
                        await PalataComments.create(data)
                ...
                console.log('ERROR in api/social/comments:', err)
                res.status(500).json({
                ...
                if (postId) {
                    let comments = await PalataComments.findAll({
                        ...
                        include: [
                            ...
                            {
                                model: PalataPosts, as: "palata_post", attributes: ['id'], where: { id: postId }
                            },
                        ],
                        order: [
                            ['nest_lvl', 'ASC'],
                ...
                if (token && commentId && content) {
                    ...
                    if (verify) {
                        ...
                        if (new Date() - comment.create_date < 3000000) {
                            ...
                            await PalataComments.update(data, {
                                where: {
                                    id: commentId
                                }
                            })
        ...
        case 'DELETE':
            try {
                ...
                if (token && commentId) {
                    let verify = verifyToken(token)
                    if (verify) {
                        let post = await PalataComments.findOne({
                            where: {
                                id: commentId
                            },
                        })
                        if (post) {
                            await PalataComments.destroy({
                                where: {
                                    id: commentId
                                }
                            })
